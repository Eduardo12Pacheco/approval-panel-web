...
export function runEditorRowCapabilitiesCheck() {
  ...
  assertIncludes(videoMarkup, 'Para volver al ajuste base', 'Expected video foreground panel to include default framing guidance');
  ...
  assertIncludes(newspaperMarkup, 'Para volver al ajuste base', 'Expected newspaper framing panel to include default framing guidance');
