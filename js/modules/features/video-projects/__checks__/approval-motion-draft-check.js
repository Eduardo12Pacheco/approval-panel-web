...
async function runBrandChannelPreviewAssetReloadCheck() {
  ...
  try {
    ...
    assertEqual(logoLayer?.style.left, '38px', 'Expected Mundial PNG logo to move right into the approved preview position');
    assertEqual(logoLayer?.style.top, '4px', 'Expected Mundial PNG logo to move up into the approved preview position');
