...
} from '../render/editor-video-picker.js';
import {
...
const videoProjectsCss = readCssWithImports(resolve(__dirname, '../../../../../styles/features/video-projects/index.css'));
const compositionRendererSource = [
  readFileSync(resolve(__dirname, '../composition/composition-renderer.js'), 'utf8'),
  readFileSync(resolve(__dirname, '../composition/renderer/dom.js'), 'utf8'),
].join('\n');
