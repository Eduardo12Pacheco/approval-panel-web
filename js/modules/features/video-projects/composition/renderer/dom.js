...
export function buildCompositionDOM(container) {
  ...
  newspaperLabel.style.cssText = 'position:absolute;left:auto;right:40px;top:40px;z-index:8;color:#000;font-family:"Versa Versa", Versa, VERSA, Inter, Arial, sans-serif;font-size:18px;font-weight:900;line-height:1.12;text-align:center;letter-spacing:0.02em;transform:none;pointer-events:none;visibility:hidden;';
