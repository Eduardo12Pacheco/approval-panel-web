  ...
  return `
    ...
    <section class="video-editor-video-selector" role="dialog" aria-modal="true" aria-label="Selector fijo de video" data-video-selector-modal data-row-id="${escapeHtmlCore(rowId)}" data-video-id="${escapeHtmlCore(selectedVideo.id)}">
      <div class="video-editor-video-selector__preview" data-video-selector-composition-preview aria-label="Preview de composición">
        ...
        <video class="video-editor-video-selector__layer video-editor-video-selector__layer--effect video-editor-video-selector__layer--effect-02" src="${escapeHtmlCore(effect2Src)}" data-layer="effect-layer-02" muted loop playsinline preload="auto" data-effect-src="${escapeHtmlCore(effect2Src)}"></video>
        <video class="video-editor-video-selector__layer video-editor-video-selector__layer--effect video-editor-video-selector__layer--effect-01" src="${escapeHtmlCore(effect1Src)}" data-layer="effect-layer-01" muted loop playsinline preload="auto" data-effect-src="${escapeHtmlCore(effect1Src)}"></video>
