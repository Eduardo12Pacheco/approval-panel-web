export const aiRescueViewHTML = `\
          <section class="ai-rescue-layout">
            <section class="panel-shell ai-rescue-panel">
              <header class="audio-queue-header">
                <div>
                  <h3>AI Rescue</h3>
                  <p id="aiRescueStatus" class="meta word-count">Cargando candidatos AI Rescue.</p>
                </div>
                <div class="ai-rescue-toolbar" aria-label="Acciones AI Rescue">
              ...
              <nav id="aiRescueTabs" class="ai-rescue-country-bar" aria-label="Países AI Rescue"></nav>
              <section id="aiRescueList" class="ai-rescue-list is-empty">Cargando candidatos AI Rescue.</section>
            </section>
          </section>
          ...
          <dialog id="aiRescueConfirmDialog">
            <article>
              ...
              <p id="aiRescueConfirmMessage">Esta acción modifica el candidato AI Rescue.</p>
