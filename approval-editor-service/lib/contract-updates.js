...
function applyContractOperations(snapshot, operations = []) {
  ...
  for (const op of operations) {
    ...
    if (op.type === "setRowImage") {
      ...
      next.assets["effect-layer-01"] = next.assets["effect-layer-01"] || { assetId: "effect-layer-01", id: "effect-layer-01", type: "video", role: "effect", renderPath: "overlays/effect-layer-01.mp4", previewUrl: "./assets/effect-layer-01.mp4", status: "ready" };
      next.assets["effect-layer-02"] = next.assets["effect-layer-02"] || { assetId: "effect-layer-02", id: "effect-layer-02", type: "video", role: "effect", renderPath: "overlays/effect-layer-02.mp4", previewUrl: "./assets/effect-layer-02.mp4", status: "ready" };
      row.media = {
